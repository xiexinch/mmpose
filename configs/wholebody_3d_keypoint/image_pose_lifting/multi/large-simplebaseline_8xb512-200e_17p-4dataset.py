...
model = dict(
    type='PoseLifter',
    backbone=dict(
        type='LargeSimpleBaseline', in_channels=17 * 2, channels=1024),
    head=dict(
...
h3wb_dataset = dict(
    ...
    pipeline=[
        dict(
            type='KeypointSelector',
            num_keypoints=17,
            mapping=[((11, 12), 0), (12, 1), (14, 2),
                     (16, 3), (11, 4), (13, 5), (15, 6), ((5, 6, 11, 12), 7),
                     ((5, 6), 8), (0, 9), ((1, 2), 10), (5, 11), (7, 12),
                     (9, 13), (6, 14), (8, 15), (10, 16)],
            flip_indices=[
